...
class VehicleSpeciesController extends Controller
{
    private $specie;
    private $title;

    public function __construct(VehicleSpecies $specie)
    {   
        $this->specie = $specie;
        $this->title = "Espécies de Veículos";
    }
    ...
    public function index()
    {
        ...
        return view('vehicle.species.index', compact('species','title','list'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validation = Validator::make($data,[
            "specie"      => ['required','string','max:191',Rule::unique('vehicle_species')]
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validation = Validator::make($data,[
            "specie"      => ['required','string','max:191',Rule::unique('vehicle_species')->ignore($id)]
        ]);
        $validation->setAttributeNames($attributeNames);
        ...
        /** database statment */        
        try{
            VehicleSpecies::find($id)->update($data);
        } catch (\Illuminate\Database\QueryException $e){
