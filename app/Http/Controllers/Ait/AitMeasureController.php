...
class AitMeasureController extends Controller
{
    private $measure;
    private $title;
 
    public function __construct(AitMeasure $measure)
    {   
        $this->measure = $measure;
        $this->title = "Medidas Administrativas"; 
    }
    ...
    public function index()
    {
        ...
        return view('ait.measure.index', compact('measures','title','list'));     
    }
    ...
    public function store(Request $request)
    {
        ...
        $attributeNames = array(
            "measure"     => "Medida Administrativa"
        );
        $validation = Validator::make($data,[
            "measure"      => ['required','string','max:191',Rule::unique('ait_measures')]
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validation = Validator::make($data,[
            "measure"      => ['required','string','max:191',Rule::unique('ait_measures')->ignore($id)]
        ]);
        $validation->setAttributeNames($attributeNames);
        ...
        /** database statment */        
        try{
            AitMeasure::find($id)->update($data);
        } catch (\Illuminate\Database\QueryException $e){
