...
class AitStatusController extends Controller
{
    private $status;
    private $title;
 
    public function __construct(AitStatus $status)
    {   
        $this->status = $status;
        $this->title = "Situação da AIT"; 
    }
    ...
    public function index()
    {
        ...
        return view('ait.status.index', compact('statuses','title','list'));     
    }
    ...
    public function store(Request $request)
    {
        ...
        $attributeNames = array(
            "status"     => "Status da AIT"
        );
        $validation = Validator::make($data,[
            "status"      => ['required','string','max:191',Rule::unique('ait_statuses')]
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validation = Validator::make($data,[
            "status"      => ['required','string','max:191',Rule::unique('ait_statuses')->ignore($id)]
        ]);
        $validation->setAttributeNames($attributeNames);
