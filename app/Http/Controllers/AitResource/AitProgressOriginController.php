...
class AitProgressOriginController extends Controller
{
    private $origin;
    private $title;
 
    public function __construct(AitProgressOrigin $origin)
    {   
        $this->origin = $origin;
        $this->title = "Origens das Informações"; 
    }
    ...
    public function index()
    {
        ...
        return view('ait.resource.progress.origin.index', compact('origins','title','list'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validation = Validator::make($data,[
            "origin"      => ['required','string','max:191',Rule::unique('ait_progress_origins')]
        ]);
    ...
    {
        return AitProgressOrigin::find($id);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validation = Validator::make($data,[
            "origin"      => ['required','string','max:191',Rule::unique('ait_progress_origins')->ignore($id)]
        ]);
        $validation->setAttributeNames($attributeNames);
        ...
        /** database statment */        
        try{
            AitProgressOrigin::find($id)->update($data);
        } catch (\Illuminate\Database\QueryException $e){
